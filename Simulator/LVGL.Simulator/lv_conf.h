 ...
 *0: to disable caching*/
#define LV_IMG_CACHE_DEF_SIZE   8  /* Keep the 2x3 LiveMap tile set plus UI images open. */
...
#define LV_USE_ASSERT_STYLE         0   /*Style checks are too expensive for this object-heavy simulator UI.*/
#define LV_USE_ASSERT_MEM_INTEGRITY 0   /*Avoid full heap scans on every critical LVGL operation.*/
#define LV_USE_ASSERT_OBJ           0   /*Avoid object tree scans during startup/dialplate animations.*/
#else
/*Enable asserts if an operation is failed or an invalid data is found.
 *If LV_USE_LOG is enabled an error message will be printed on failure*/
