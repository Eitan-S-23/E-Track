...
用户授权治理会话决策并落盘，现按 `OTA-DEC-013` 采用方案 A：P3-3 完成前
必须取得实际 APK 安装和 toy/真包实机闭环证据；P3-5 继续承担真实后端候选链
与 10/10 独立断连续传。两份 Spec 和看板已同步，R2 的“归属待裁定”至此
结束；上文是 2026-09-07 的历史原文，不再作为该问题仍未裁定的依据。

P3-3 可先进行自身真机验收，不等待 P3-5 开始；具体可启动资产、设备身份、
命令和操作授权仍须在正式合同中明确。未取得的证据不能记 PASS，P3-3 不因
本裁定完成；实施前置、冻结协议和历史验收资产不变。详细依据与验证见
