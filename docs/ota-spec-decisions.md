...
本文件只记录决策过程、责任人和落盘目标，不是接口真相源。接口裁定写入对应领域合同；任务边界裁定同步到看板和受影响 Spec，不改写冻结二进制或历史验收合同。用户在记录 9 中批准 OTA-DEC-001 至 OTA-DEC-012 并授权冻结规范；OTA-DEC-013 依据记录 10 的单独授权裁定。用户原话与参数细化保留在下文。
