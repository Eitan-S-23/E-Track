...
#define Z7_BSWAP32_CONST(v) \
  ((((UInt32)(v) << 24)) | (((UInt32)(v) << 8) & (UInt32)0xff0000) | (((UInt32)(v) >> 8) & (UInt32)0xff00) | (((UInt32)(v) >> 24)))
...
#elif (defined(__GNUC__) && (__GNUC__ > 4 || (__GNUC__ == 4 && __GNUC_MINOR__ >= 3))) || (defined(__clang__) && Z7_has_builtin(__builtin_bswap16))
...
#define Z7_BSWAP16(v) ((UInt16)(((UInt32)(v) << 8) | ((UInt32)(v) >> 8)))

#define Z7_BSWAP32(v) Z7_BSWAP32_CONST(v)

#define Z7_BSWAP64(v) \
  ((((UInt64)(v)) << 8 * 7) | (((UInt64)(v) & ((UInt32)0xff << 8 * 1)) << 8 * 5) | (((UInt64)(v) & ((UInt32)0xff << 8 * 2)) << 8 * 3) | (((UInt64)(v) & ((UInt32)0xff << 8 * 3)) << 8 * 1) | (((UInt64)(v) >> 8 * 1) & ((UInt32)0xff << 8 * 3)) | (((UInt64)(v) >> 8 * 3) & ((UInt32)0xff << 8 * 2)) | (((UInt64)(v) >> 8 * 5) & ((UInt32)0xff << 8 * 1)) | (((UInt64)(v) >> 8 * 7)))
...
#if defined(MY_CPU_X86_OR_AMD64) || defined(MY_CPU_ARM_OR_ARM64) || defined(MY_CPU_PPC_OR_PPC64)
